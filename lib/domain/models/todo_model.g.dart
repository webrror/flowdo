...
extension TodoModelQueryFilter
  ...
  QueryBuilder<TodoModel, TodoModel, QAfterFilterCondition> createdOnEqualTo(
      DateTime value) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
  ...
  QueryBuilder<TodoModel, TodoModel, QAfterFilterCondition> createdOnLessThan(
    DateTime value, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<TodoModel, TodoModel, QAfterFilterCondition> createdOnBetween(
    DateTime lower,
    DateTime upper, {
    bool includeLower = true,
    bool includeUpper = true,
...
extension TodoModelQuerySortBy on QueryBuilder<TodoModel, TodoModel, QSortBy> {
  ...
  QueryBuilder<TodoModel, TodoModel, QAfterSortBy> sortByCreatedOn() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'createdOn', Sort.asc);
    });
  }

  QueryBuilder<TodoModel, TodoModel, QAfterSortBy> sortByCreatedOnDesc() {
    return QueryBuilder.apply(this, (query) {
...
extension TodoModelQuerySortThenBy
  ...
  QueryBuilder<TodoModel, TodoModel, QAfterSortBy> thenByCreatedOn() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'createdOn', Sort.asc);
    });
  }

  QueryBuilder<TodoModel, TodoModel, QAfterSortBy> thenByCreatedOnDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'createdOn', Sort.desc);
    });
  }
...
extension TodoModelQueryWhereDistinct
  ...
  QueryBuilder<TodoModel, TodoModel, QDistinct> distinctByCreatedOn() {
    return QueryBuilder.apply(this, (query) {
...
extension TodoModelQueryProperty
  ...
  QueryBuilder<TodoModel, DateTime, QQueryOperations> createdOnProperty() {
    return QueryBuilder.apply(this, (query) {
